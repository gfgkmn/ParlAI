...
"""(A partial) implementation of the RNET Document Reader from:
...
class RnetAgent(Agent):
    ...
    def __init__(self, opt, shared=None):
        ...
        # Load dict.
        if not shared:
            word_dict = RnetAgent.dictionary_class()(opt)
    ...
    def _find_target(self, document, labels):
        ...
        # so we could know rnet's hypothesis is still squad-like dataset.
