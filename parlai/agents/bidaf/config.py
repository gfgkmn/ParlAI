...
def add_cmdline_args(parser):
    # Runtime environment
    agent = parser.add_argument_group('Bidaf Arguments')
    ...
    agent.add_argument('--num_features', type=int, default=4)
    agent.add_argument('--pos', type=bool, default=True)
    agent.add_argument('--pos_size', type=int, default=56,
                        help='how many kinds of POS tags.')
    agent.add_argument('--pos_dim', type=int, default=12,
                        help='the embedding dimension for POS tags.')
    agent.add_argument('--ner', type=bool, default=True)
    agent.add_argument('--ner_size', type=int, default=19,
                        help='how many kinds of named entity tags.')
    agent.add_argument('--ner_dim', type=int, default=8,
